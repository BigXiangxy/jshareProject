...
import static com.weex.app.weexmodule.JShareModule.ALL_FLAG;
...
public class ShareBoard {
    ...
    public ShareBoard addButton(String showword, String Keyword, String icon, String Grayicon) {
        this.platformlist.add(createSnsPlatform(showword, Keyword, icon, Grayicon, 0, ALL_FLAG));
        return this;
    }

    public static SnsPlatform createSnsPlatform(String showword, String Keyword, String icon, String Grayicon, int indext, int flag) {
